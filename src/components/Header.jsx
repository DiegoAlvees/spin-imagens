...
export default function Header() {
  ...
  return (
    <div>
      <nav className="flex justify-between lg:justify-center items-center text-[16px] md:text-[18px] gap-6 fixed top-0 left-0 z-50 w-full h-16 bg-black/50 backdrop-blur-sm px-3">
