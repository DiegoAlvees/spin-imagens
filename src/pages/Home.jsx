...
export default function Home() {
  return (
    <div className="md:grid grid-cols-2 bg-gradient-to-t from-blue-950 to-black md:items-center md:h-screen">
      <div className="relative w-full  h-screen bg-black  md:w-72 md:ml-[8rem] md:flex  md:h-[500px]">
        <img
          src={PhoneSvg}
          alt=""
          className="hidden md:flex md:w-[300px] h-[494px] absolute top-0 left-0 z-20 scale-110"
        />
        <video
          className="absolute md:relative top-0 left-0 l-5 w-full h-full  object-cover  opacity-80 video-bg md:rounded-lg 
           "
          autoPlay
          loop
          muted
